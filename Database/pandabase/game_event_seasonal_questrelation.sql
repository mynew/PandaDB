...
-- Dumping structure for table pandabase.game_event_seasonal_questrelation
...
-- Dumping data for table pandabase.game_event_seasonal_questrelation: ~377 rows (approximately)
