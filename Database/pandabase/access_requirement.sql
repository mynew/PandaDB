...
-- Dumping structure for table pandabase.access_requirement
...
-- Dumping data for table pandabase.access_requirement: 149 rows
...
INSERT INTO `access_requirement` (`mapId`, `difficulty`, `level_min`, `level_max`, `item`, `item2`, `quest_done_A`, `quest_done_H`, `completed_achievement`, `quest_failed_text`, `comment`) VALUES
	...
	(189, 0, 21, 0, 0, 0, 0, 0, 0, NULL, 'Scarlet Monastery - Graveyard (Entrance)'),
	...
	(269, 0, 66, 0, 0, 0, 0, 0, 0, 'You must complete the quest "Return to Andormu" before entering the Black Morass.', 'Caverns Of Time,Black Morass (Entrance)'),
	(269, 1, 70, 0, 0, 0, 0, 0, 0, 'You must complete the quest "Return to Andormu" and be level 70 before entering the Heroic difficulty of the Black Morass.', 'Caverns Of Time,Black Morass (Entrance)'),
	(289, 0, 37, 0, 0, 0, 0, 0, 0, NULL, 'Scholomance Entrance'),
	...
	(469, 0, 55, 0, 0, 0, 0, 0, 0, NULL, 'Blackwing Lair - Blackrock Mountain - Eastern Kingdoms'),
	...
	(540, 1, 70, 0, 0, 0, 0, 0, 0, NULL, 'The Shattered Halls (Entrance)'),
	(542, 0, 55, 0, 0, 0, 0, 0, 0, NULL, 'The Blood Furnace (Entrance)'),
	(542, 1, 70, 0, 0, 0, 0, 0, 0, NULL, 'The Blood Furnace (Entrance)'),
	...
	(545, 1, 70, 0, 0, 0, 0, 0, 0, NULL, 'The Steamvault (Entrance)'),
	(546, 0, 55, 0, 0, 0, 0, 0, 0, NULL, 'The Underbog (Entrance)'),
	(546, 1, 70, 0, 0, 0, 0, 0, 0, NULL, 'The Underbog (Entrance)'),
	(547, 0, 55, 0, 0, 0, 0, 0, 0, NULL, 'The Slave Pens (Entrance)'),
	(547, 1, 70, 0, 0, 0, 0, 0, 0, NULL, 'The Slave Pens (Entrance)'),
	...
	(552, 1, 70, 0, 0, 0, 0, 0, 0, NULL, 'The Arcatraz (Entrance)'),
	(553, 0, 68, 0, 0, 0, 0, 0, 0, NULL, 'The Botanica (Entrance)'),
	(553, 1, 70, 0, 0, 0, 0, 0, 0, NULL, 'The Botanica (Entrance)'),
	(554, 0, 68, 0, 0, 0, 0, 0, 0, NULL, 'The Mechanar (Entrance)'),
	(554, 1, 70, 0, 0, 0, 0, 0, 0, NULL, 'The Mechanar (Entrance)'),
	(555, 0, 65, 0, 0, 0, 0, 0, 0, NULL, 'Shadow Labyrinth (Entrance)'),
	(555, 1, 70, 0, 0, 0, 0, 0, 0, NULL, 'Shadow Labyrinth (Entrance)'),
	(556, 0, 55, 0, 0, 0, 0, 0, 0, NULL, 'Sethekk Halls (Entrance)'),
	(556, 1, 70, 0, 0, 0, 0, 0, 0, NULL, 'Sethekk Halls (Entrance)'),
	(557, 0, 55, 0, 0, 0, 0, 0, 0, NULL, 'Mana Tombs (Entrance)'),
	(557, 1, 70, 0, 0, 0, 0, 0, 0, NULL, 'Mana Tombs (Entrance)'),
	(558, 0, 55, 0, 0, 0, 0, 0, 0, NULL, 'Auchenai Crypts (Entrance)'),
	(558, 1, 70, 0, 0, 0, 0, 0, 0, NULL, 'Auchenai Crypts (Entrance)'),
	(560, 0, 66, 0, 0, 0, 0, 0, 0, NULL, 'Caverns Of Time,Old Hillsbrad Foothills (Entrance)'),
	(560, 1, 70, 0, 0, 0, 0, 0, 0, NULL, 'Caverns Of Time,Old Hillsbrad Foothills (Entrance)'),
	...
	(585, 1, 70, 0, 0, 0, 0, 0, 0, NULL, 'Magisters\' Terrace (Entrance)'),
	...
	(632, 0, 75, 0, 0, 0, 0, 0, 0, NULL, 'Forge of Souls (Entrance)'),
	...
	(658, 0, 75, 0, 0, 0, 24499, 24511, 0, NULL, 'Pit of Saron (Entrance)'),
	(658, 1, 80, 0, 0, 0, 24499, 24511, 0, NULL, 'Pit of Saron (Entrance)'),
	(668, 0, 75, 0, 0, 0, 24710, 24712, 0, NULL, 'Halls of Reflection (Entrance)'),
	...
	(755, 0, 85, 0, 0, 0, 0, 0, 0, NULL, 'Lost City of the Tol\'vir (Enterence)'),
	(755, 1, 85, 0, 0, 0, 0, 0, 0, NULL, 'Lost City of the Tol\'vir (Enterence)'),
	(643, 0, 80, 0, 0, 0, 0, 0, 0, NULL, 'Throne of the Tides (Enterence)'),
	(643, 1, 80, 0, 0, 0, 0, 0, 0, NULL, 'Throne of the Tides (Enterence)'),
	(645, 0, 80, 0, 0, 0, 0, 0, 0, NULL, 'Blackrock Caverns (Enterence)'),
	(645, 1, 80, 0, 0, 0, 0, 0, 0, NULL, 'Blackrock Caverns (Enterence)'),
	(720, 0, 80, 0, 0, 0, 0, 0, 0, NULL, 'Firelands (Enterence)'),
	(670, 0, 84, 0, 0, 0, 0, 0, 0, NULL, 'Grim Batol (Enterence)'),
	(670, 1, 85, 0, 0, 0, 0, 0, 0, NULL, 'Grim Batol (Enterence)'),
	(644, 0, 84, 0, 0, 0, 0, 0, 0, NULL, 'Halls of Origination (Enterence)'),
	(644, 1, 85, 0, 0, 0, 0, 0, 0, NULL, 'Halls of Origination (Enterence)'),
	(725, 0, 81, 0, 0, 0, 0, 0, 0, NULL, 'The Stonecore (Enterence)'),
	(725, 1, 85, 0, 0, 0, 0, 0, 0, NULL, 'The Stonecore (Enterence)'),
	(657, 0, 81, 0, 0, 0, 0, 0, 0, NULL, 'The Vortex Pinnacle (Enterence)'),
