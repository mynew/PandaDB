...
-- Dumping structure for table pandabase.command
...
-- Dumping data for table pandabase.command: 418 rows
...
INSERT INTO `command` (`name`, `security`, `help`) VALUES
	...
	('reload wp_data', 3, 'Syntax: .reload wp_data will reload waypoint_data table.');
