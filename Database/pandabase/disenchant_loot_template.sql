...
-- Dumping structure for table pandabase.disenchant_loot_template
DROP TABLE IF EXISTS `disenchant_loot_template`;
CREATE TABLE IF NOT EXISTS `disenchant_loot_template` (
  `entry` mediumint(8) DEFAULT NULL,
  `item` mediumint(8) DEFAULT NULL,
  `ChanceOrQuestChance` float DEFAULT NULL,
  `lootmode` smallint(5) DEFAULT NULL,
  `groupid` tinyint(3) DEFAULT NULL,
  `mincountOrRef` mediumint(9) DEFAULT NULL,
  `maxcount` tinyint(3) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;

-- Dumping data for table pandabase.disenchant_loot_template: ~177 rows (approximately)
...
INSERT INTO `disenchant_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `lootmode`, `groupid`, `mincountOrRef`, `maxcount`) VALUES
	...
	(54504, 52722, 100, 1, 0, 1, 2),
	(65066, 52722, 100, 1, 0, 1, 2),
	(59312, 52722, 100, 1, 0, 1, 2);
