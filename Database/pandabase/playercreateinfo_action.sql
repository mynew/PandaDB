...
-- Dumping structure for table pandabase.playercreateinfo_action
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Start player actions';

-- Dumping data for table pandabase.playercreateinfo_action: 446 rows
