...
-- Dumping structure for table pandabase.player_factionchange_achievement
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Achievements when change faction';

-- Dumping data for table pandabase.player_factionchange_achievement: 124 rows
